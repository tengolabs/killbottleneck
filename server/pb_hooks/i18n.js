...
const STRINGS = {
  ...
  "err.chatPdfShape": { cs: "Text z PDF má špatný tvar — zkuste soubor přiložit znovu.", en: "The PDF text has a wrong shape — try attaching the file again." },
  "err.chatPdfTooBig": { cs: "PDF je pro asistenta moc dlouhé (nejvýš {strany} stran a {max} znaků textu). V záložce PDF z něj vyjměte jen strany, které chcete opravit.", en: "The PDF is too long for the assistant (at most {strany} pages and {max} characters of text). In the PDF tab extract only the pages you want to correct." },
